...
`
  ...
  function renderChapter(chapterId) {
    ...
    // Post-render: highlight code, add collapsible sections, add animation buttons
    highlightCode();
  ...
  /** Add "查看动画" buttons for DEM concept SVGs */
  function addAnimationButtons() {
    var mdEl = $content.querySelector(".md-content");
    if (!mdEl) return;

    // Add animation buttons at strategic locations based on chapter
    var firstH2 = mdEl.querySelector("h2");
    if (firstH2) {
      var btn = document.createElement("button");
      btn.className = "view-animation-btn";
      btn.textContent = "查看碰撞检测动画";
      btn.onclick = function () { App.showAnimation("collision"); };
      firstH2.parentNode.insertBefore(btn, firstH2.nextSibling);
    }
  }
